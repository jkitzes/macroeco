...
'criteria' : How one would like to divide her dataset when calculating the 
...
asklist = {'subset':'Empty or ?',
           'criteria': "At least two of: 'spp':colname, 'count':colname; use quotation marks and colons",
           'dist_list': "At least one of: geo_ser, lognorm, broken_stick,logser_ut; divide with commas"}
