...
optional_params = {'truncation_symbols' : (truncation_symbols + ''' Optional.
                    Default: ''', [None]), 'remove_replace_values':
                    (remove_replace_values + ''' Optional. Default: ''',
                    [(None, None)]), 'char_btwn_species_and_count' :
                    (char_btwn_species_and_count + ''' Optional. Default: ''',
                    ['-']), 'char_btwn_species': (char_btwn_species + '''
                    Optional. Default: ''', ['\n']), 'columns_to_split' :
                    (columns_to_split + ''' Optional. Default : ''', None),
