# -*- coding: utf-8 -*-
#
# macroeco documentation build configuration file, created by
...
exclude_patterns = ['_build', '_ext', '_templates']
...
MOCK_MODULES = ['shapely', 'shapely.geometry', 'scipy', 'scipy.stats']
